...
export function prepareSvg(svgRoot, selectedLbl, btnOk, btnCancel){
  ...
  shapes.forEach(el=>{
    ...
    target.addEventListener('pointerup', ev=>{
      ...
      if (selectedEl === el){ clearSelection(selectedLbl, btnOk, btnCancel); return; }
      if (selectedEl) clearSelection(selectedLbl, btnOk, btnCancel);
...
export function clearSelection(selectedLbl, btnOk, btnCancel){
